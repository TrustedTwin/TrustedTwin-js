...
export function InvalidateHandlerResponseFromJSON(
  json: any
): InvalidateHandlerResponse {
  return InvalidateHandlerResponseFromJSONTyped(json, false);
}

export function InvalidateHandlerResponseFromJSONTyped(
  json: any,
...
export function InvalidateHandlerResponseToJSON(
  value?: InvalidateHandlerResponse | null
): any {
  if (value === undefined) {
    return undefined;
  }
