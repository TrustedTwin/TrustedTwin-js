...
export function DeleteIndexesTable200ResponseFromJSON(
  json: any
): DeleteIndexesTable200Response {
  return DeleteIndexesTable200ResponseFromJSONTyped(json, false);
}

export function DeleteIndexesTable200ResponseFromJSONTyped(
  json: any,
...
export function DeleteIndexesTable200ResponseToJSON(
  value?: DeleteIndexesTable200Response | null
): any {
  if (value === undefined) {
    return undefined;
  }
