...
export function TruncateIndexesTable200ResponseFromJSON(
  json: any
): TruncateIndexesTable200Response {
  return TruncateIndexesTable200ResponseFromJSONTyped(json, false);
}

export function TruncateIndexesTable200ResponseFromJSONTyped(
  json: any,
...
export function TruncateIndexesTable200ResponseToJSON(
  value?: TruncateIndexesTable200Response | null
): any {
  if (value === undefined) {
    return undefined;
  }
