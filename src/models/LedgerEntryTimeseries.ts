...
export function LedgerEntryTimeseriesFromJSON(
  json: any
): LedgerEntryTimeseries {
  return LedgerEntryTimeseriesFromJSONTyped(json, false);
}

export function LedgerEntryTimeseriesFromJSONTyped(
  json: any,
...
export function LedgerEntryTimeseriesToJSON(
  value?: LedgerEntryTimeseries | null
): any {
  if (value === undefined) {
    return undefined;
  }
