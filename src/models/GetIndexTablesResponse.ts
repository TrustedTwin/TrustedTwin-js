...
export function GetIndexTablesResponseFromJSON(
  json: any
): GetIndexTablesResponse {
  return GetIndexTablesResponseFromJSONTyped(json, false);
}

export function GetIndexTablesResponseFromJSONTyped(
  json: any,
  ...
  return {
    ...
    users: !exists(json, "users")
      ? undefined
      : mapValues(json["users"], ServicesDatabaseUserAccessCommandFromJSON),
    indexes: !exists(json, "indexes") ? undefined : json["indexes"],
  };
}

export function GetIndexTablesResponseToJSON(
  value?: GetIndexTablesResponse | null
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    ...
    users:
      value.users === undefined
        ? undefined
        : mapValues(value.users, ServicesDatabaseUserAccessCommandToJSON),
