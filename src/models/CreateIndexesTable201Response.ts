...
export function CreateIndexesTable201ResponseFromJSON(
  json: any
): CreateIndexesTable201Response {
  return CreateIndexesTable201ResponseFromJSONTyped(json, false);
}

export function CreateIndexesTable201ResponseFromJSONTyped(
  json: any,
...
export function CreateIndexesTable201ResponseToJSON(
  value?: CreateIndexesTable201Response | null
): any {
  if (value === undefined) {
    return undefined;
  }
