...
export function GetTimeseriesTablesResponseFromJSON(
  json: any
): GetTimeseriesTablesResponse {
  return GetTimeseriesTablesResponseFromJSONTyped(json, false);
}

export function GetTimeseriesTablesResponseFromJSONTyped(
  json: any,
...
export function GetTimeseriesTablesResponseToJSON(
  value?: GetTimeseriesTablesResponse | null
): any {
  if (value === undefined) {
    return undefined;
  }
