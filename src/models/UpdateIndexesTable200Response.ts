...
export function UpdateIndexesTable200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateIndexesTable200Response {
...
export function UpdateIndexesTable200ResponseToJSON(value?: UpdateIndexesTable200Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
