...
export function UpdateTimeseriesTable200ResponseFromJSON(
  json: any
): UpdateTimeseriesTable200Response {
  return UpdateTimeseriesTable200ResponseFromJSONTyped(json, false);
}

export function UpdateTimeseriesTable200ResponseFromJSONTyped(
  json: any,
...
export function UpdateTimeseriesTable200ResponseToJSON(
  value?: UpdateTimeseriesTable200Response | null
): any {
  if (value === undefined) {
    return undefined;
  }
