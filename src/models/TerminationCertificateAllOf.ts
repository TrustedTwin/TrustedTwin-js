...
export function TerminationCertificateAllOfFromJSON(
  json: any
): TerminationCertificateAllOf {
  return TerminationCertificateAllOfFromJSONTyped(json, false);
}

export function TerminationCertificateAllOfFromJSONTyped(
  json: any,
...
export function TerminationCertificateAllOfToJSON(
  value?: TerminationCertificateAllOf | null
): any {
  if (value === undefined) {
    return undefined;
  }
