...
export function IndexTableResponseStatsFromJSON(
  json: any
): IndexTableResponseStats {
  return IndexTableResponseStatsFromJSONTyped(json, false);
}

export function IndexTableResponseStatsFromJSONTyped(
  json: any,
...
export function IndexTableResponseStatsToJSON(
  value?: IndexTableResponseStats | null
): any {
  if (value === undefined) {
    return undefined;
  }
