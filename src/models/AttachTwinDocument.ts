...
export type AttachTwinDocumentStorageClassEnum =
  typeof AttachTwinDocumentStorageClassEnum[keyof typeof AttachTwinDocumentStorageClassEnum];

export function AttachTwinDocumentFromJSON(json: any): AttachTwinDocument {
  return AttachTwinDocumentFromJSONTyped(json, false);
}

export function AttachTwinDocumentFromJSONTyped(
  json: any,
...
export function AttachTwinDocumentToJSON(
  value?: AttachTwinDocument | null
): any {
  if (value === undefined) {
    return undefined;
  }
