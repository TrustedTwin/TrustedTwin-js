...
export function TruncateTimeseriesTable200ResponseFromJSON(
  json: any
): TruncateTimeseriesTable200Response {
  return TruncateTimeseriesTable200ResponseFromJSONTyped(json, false);
}

export function TruncateTimeseriesTable200ResponseFromJSONTyped(
  json: any,
...
export function TruncateTimeseriesTable200ResponseToJSON(
  value?: TruncateTimeseriesTable200Response | null
): any {
  if (value === undefined) {
    return undefined;
  }
