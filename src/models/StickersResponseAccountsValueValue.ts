...
export function StickersResponseAccountsValueValueFromJSON(
  json: any
): StickersResponseAccountsValueValue {
  return StickersResponseAccountsValueValueFromJSONTyped(json, false);
}

export function StickersResponseAccountsValueValueFromJSONTyped(
  json: any,
...
export function StickersResponseAccountsValueValueToJSON(
  value?: StickersResponseAccountsValueValue | null
): any {
  if (value === undefined) {
    return undefined;
  }
