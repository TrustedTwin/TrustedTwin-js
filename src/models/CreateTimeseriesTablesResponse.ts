...
export function CreateTimeseriesTablesResponseFromJSON(
  json: any
): CreateTimeseriesTablesResponse {
  return CreateTimeseriesTablesResponseFromJSONTyped(json, false);
}

export function CreateTimeseriesTablesResponseFromJSONTyped(
  json: any,
...
export function CreateTimeseriesTablesResponseToJSON(
  value?: CreateTimeseriesTablesResponse | null
): any {
  if (value === undefined) {
    return undefined;
  }
