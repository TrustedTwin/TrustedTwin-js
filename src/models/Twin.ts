...
export function TwinFromJSONTyped(
  json: any,
  ...
  return {
    ...
    creationCertificate: !exists(json, "creation_certificate")
      ? undefined
      : TwinCreationCertificateFromJSON(json["creation_certificate"]),
    terminationCertificate: !exists(json, "termination_certificate")
      ? undefined
      : TwinTerminationCertificateFromJSON(json["termination_certificate"]),
  };
}
...
export function TwinToJSON(value?: Twin | null): any {
  ...
  return {
    ...
    creation_certificate: TwinCreationCertificateToJSON(
      value.creationCertificate
    ),
    termination_certificate: TwinTerminationCertificateToJSON(
