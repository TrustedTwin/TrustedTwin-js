...
export function ServicesDatabaseUsersAccessFromJSON(
  json: any
): ServicesDatabaseUsersAccess {
  return ServicesDatabaseUsersAccessFromJSONTyped(json, false);
}

export function ServicesDatabaseUsersAccessFromJSONTyped(
  json: any,
...
export function ServicesDatabaseUsersAccessToJSON(
  value?: ServicesDatabaseUsersAccess | null
): any {
  if (value === undefined) {
    return undefined;
  }
