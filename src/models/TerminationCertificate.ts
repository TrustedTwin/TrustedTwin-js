...
export function TerminationCertificateFromJSON(
  json: any
): TerminationCertificate {
  return TerminationCertificateFromJSONTyped(json, false);
}

export function TerminationCertificateFromJSONTyped(
  json: any,
...
export function TerminationCertificateToJSON(
  value?: TerminationCertificate | null
): any {
  if (value === undefined) {
    return undefined;
  }
