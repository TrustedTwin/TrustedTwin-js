...
export type GetDocStorageClassEnum =
  typeof GetDocStorageClassEnum[keyof typeof GetDocStorageClassEnum];
...
export type GetDocStatusEnum =
  typeof GetDocStatusEnum[keyof typeof GetDocStatusEnum];

export function GetDocFromJSON(json: any): GetDoc {
  return GetDocFromJSONTyped(json, false);
}

export function GetDocFromJSONTyped(
  json: any,
  ...
  return {
    creationCertificate: !exists(json, "creation_certificate")
      ? undefined
      : DocCreationCertificateFromJSON(json["creation_certificate"]),
    storageClass: !exists(json, "storage_class")
      ? undefined
      : json["storage_class"],
    ...
    download: !exists(json, "download")
      ? undefined
      : GetDocDownloadFromJSON(json["download"]),
  };
}
...
export function GetDocToJSON(value?: GetDoc | null): any {
  ...
  return {
    creation_certificate: DocCreationCertificateToJSON(
      value.creationCertificate
    ),
