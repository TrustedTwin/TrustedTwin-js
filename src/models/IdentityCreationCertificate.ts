...
export function IdentityCreationCertificateFromJSON(
  json: any
): IdentityCreationCertificate {
  return IdentityCreationCertificateFromJSONTyped(json, false);
}

export function IdentityCreationCertificateFromJSONTyped(
  json: any,
...
export function IdentityCreationCertificateToJSON(
  value?: IdentityCreationCertificate | null
): any {
  if (value === undefined) {
    return undefined;
  }
