...
export function TwinCreationCertificateAllOfFromJSON(
  json: any
): TwinCreationCertificateAllOf {
  return TwinCreationCertificateAllOfFromJSONTyped(json, false);
}

export function TwinCreationCertificateAllOfFromJSONTyped(
  json: any,
...
export function TwinCreationCertificateAllOfToJSON(
  value?: TwinCreationCertificateAllOf | null
): any {
  if (value === undefined) {
    return undefined;
  }
