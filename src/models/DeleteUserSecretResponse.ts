...
export function DeleteUserSecretResponseFromJSON(
  json: any
): DeleteUserSecretResponse {
  return DeleteUserSecretResponseFromJSONTyped(json, false);
}

export function DeleteUserSecretResponseFromJSONTyped(
  json: any,
...
export function DeleteUserSecretResponseToJSON(
  value?: DeleteUserSecretResponse | null
): any {
  if (value === undefined) {
    return undefined;
  }
