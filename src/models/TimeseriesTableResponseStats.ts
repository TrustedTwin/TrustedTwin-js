...
export function TimeseriesTableResponseStatsFromJSON(
  json: any
): TimeseriesTableResponseStats {
  return TimeseriesTableResponseStatsFromJSONTyped(json, false);
}

export function TimeseriesTableResponseStatsFromJSONTyped(
  json: any,
...
export function TimeseriesTableResponseStatsToJSON(
  value?: TimeseriesTableResponseStats | null
): any {
  if (value === undefined) {
    return undefined;
  }
