...
export function StickersListStickersInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): StickersListStickersInner {
...
export function StickersListStickersInnerToJSON(value?: StickersListStickersInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
