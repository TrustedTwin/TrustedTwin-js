...
export function WebhookUnsubscribeResponseFromJSON(
  json: any
): WebhookUnsubscribeResponse {
  return WebhookUnsubscribeResponseFromJSONTyped(json, false);
}

export function WebhookUnsubscribeResponseFromJSONTyped(
  json: any,
...
export function WebhookUnsubscribeResponseToJSON(
  value?: WebhookUnsubscribeResponse | null
): any {
  if (value === undefined) {
    return undefined;
  }
