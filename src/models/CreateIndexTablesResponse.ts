...
export function CreateIndexTablesResponseFromJSON(
  json: any
): CreateIndexTablesResponse {
  return CreateIndexTablesResponseFromJSONTyped(json, false);
}

export function CreateIndexTablesResponseFromJSONTyped(
  json: any,
...
export function CreateIndexTablesResponseToJSON(
  value?: CreateIndexTablesResponse | null
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    indexes:
      value.indexes === undefined
        ? undefined
        : mapValues(value.indexes, CreateIndexTablesResponseIndexesValueToJSON),
  };
}
