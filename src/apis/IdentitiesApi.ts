...
export class IdentitiesApi extends runtime.BaseAPI {
  ...
  async createTwinIdentityRaw(
    requestParameters: IdentitiesApiCreateTwinIdentityRequest,
  ...
  async deleteTwinIdentityRaw(
    requestParameters: IdentitiesApiDeleteTwinIdentityRequest,
    initOverrides?: RequestInit | runtime.InitOverideFunction
  ...
  async getTwinIdentitiesRaw(
    requestParameters: IdentitiesApiGetTwinIdentitiesRequest,
    initOverrides?: RequestInit | runtime.InitOverideFunction
  ): Promise<runtime.ApiResponse<Array<string>>> {
    if (
      requestParameters.twin === null ||
  ...
  async getTwinIdentityRaw(
    requestParameters: IdentitiesApiGetTwinIdentityRequest,
    initOverrides?: RequestInit | runtime.InitOverideFunction
  ...
  async resolveTwinIdentityRaw(
    requestParameters: IdentitiesApiResolveTwinIdentityRequest,
    initOverrides?: RequestInit | runtime.InitOverideFunction
  ...
  async updateTwinIdentityRaw(
    requestParameters: IdentitiesApiUpdateTwinIdentityRequest,
    initOverrides?: RequestInit | runtime.InitOverideFunction
  ): Promise<runtime.ApiResponse<IdentityProperties>> {
    if (
      requestParameters.twin === null ||
