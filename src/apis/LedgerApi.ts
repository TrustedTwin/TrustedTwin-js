...
export class LedgerApi extends runtime.BaseAPI {
     ...
     */
    async addTwinLedgerEntryRaw(requestParameters: LedgerApiAddTwinLedgerEntryRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<UserLedger>> {
     ...
     * Add one or more Entries to Ledger
     */
    async addTwinLedgerEntry(requestParameters: LedgerApiAddTwinLedgerEntryRequest, initOverrides?: RequestInit): Promise<UserLedger> {
     ...
     */
    async deleteTwinLedgerEntryRaw(requestParameters: LedgerApiDeleteTwinLedgerEntryRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.twin === null || requestParameters.twin === undefined) {
     ...
     * Delete Entry from Ledger
     */
    async deleteTwinLedgerEntry(requestParameters: LedgerApiDeleteTwinLedgerEntryRequest, initOverrides?: RequestInit): Promise<void> {
     ...
     */
    async getTwinLedgerEntryRaw(requestParameters: LedgerApiGetTwinLedgerEntryRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<UserLedger>> {
        if (requestParameters.twin === null || requestParameters.twin === undefined) {
     ...
     * Get Entry from Ledger
     */
    async getTwinLedgerEntry(requestParameters: LedgerApiGetTwinLedgerEntryRequest, initOverrides?: RequestInit): Promise<UserLedger> {
     ...
     */
    async getTwinLedgerEntryHistoryRaw(requestParameters: LedgerApiGetTwinLedgerEntryHistoryRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<LedgerEntriesHistory>> {
        if (requestParameters.twin === null || requestParameters.twin === undefined) {
     ...
     * Get Ledger Entry History
     */
    async getTwinLedgerEntryHistory(requestParameters: LedgerApiGetTwinLedgerEntryHistoryRequest, initOverrides?: RequestInit): Promise<LedgerEntriesHistory> {
     ...
     */
    async updateTwinLedgerEntryRaw(requestParameters: LedgerApiUpdateTwinLedgerEntryRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<PatchedUserLedger>> {
        if (requestParameters.twin === null || requestParameters.twin === undefined) {
     ...
     * PATCH one or more Entries in given Ledger
     */
    async updateTwinLedgerEntry(requestParameters: LedgerApiUpdateTwinLedgerEntryRequest, initOverrides?: RequestInit): Promise<PatchedUserLedger> {
