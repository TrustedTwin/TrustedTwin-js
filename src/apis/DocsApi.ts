...
export class DocsApi extends runtime.BaseAPI {
  ...
  async attachTwinDocRaw(
    requestParameters: DocsApiAttachTwinDocRequest,
   ...
   */
  async createUploadUrlRaw(
    initOverrides?: RequestInit | runtime.InitOverideFunction
  ): Promise<runtime.ApiResponse<FileAddResponse>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      FileAddResponseFromJSON(jsonValue)
    );
  }
  ...
  async deleteTwinDocRaw(
    requestParameters: DocsApiDeleteTwinDocRequest,
    initOverrides?: RequestInit | runtime.InitOverideFunction
  ...
  async deleteTwinDocsRaw(
    requestParameters: DocsApiDeleteTwinDocsRequest,
    initOverrides?: RequestInit | runtime.InitOverideFunction
  ): Promise<runtime.ApiResponse<GetDoc>> {
    if (
      requestParameters.twin === null ||
   ...
   */
  async downloadDocRaw(
    requestParameters: DocsApiDownloadDocRequest,
    initOverrides?: RequestInit | runtime.InitOverideFunction
    ...
    if (
      ...
      throw new runtime.RequiredError(
        "account",
        "Required parameter requestParameters.account was null or undefined when calling downloadDoc."
      );
    }

    if (
      requestParameters.handler === null ||
      requestParameters.handler === undefined
    ) {
      throw new runtime.RequiredError(
        "handler",
        "Required parameter requestParameters.handler was null or undefined when calling downloadDoc."
      );
    }
    ...
    const response = await this.request(
      {
        path: `/download/{account}/{handler}`
          ...
          .replace(
            `{${"handler"}}`,
            encodeURIComponent(String(requestParameters.handler))
          ),
        method: "GET",
        headers: headerParameters,
        query: queryParameters,
   ...
   */
  async getTwinDocRaw(
    requestParameters: DocsApiGetTwinDocRequest,
    initOverrides?: RequestInit | runtime.InitOverideFunction
  ): Promise<runtime.ApiResponse<GetDoc>> {
    if (
      requestParameters.twin === null ||
  ...
  async getTwinDocsRaw(
    requestParameters: DocsApiGetTwinDocsRequest,
    initOverrides?: RequestInit | runtime.InitOverideFunction
   ...
   */
  async invalidateUploadUrlRaw(
    requestParameters: DocsApiInvalidateUploadUrlRequest,
    initOverrides?: RequestInit | runtime.InitOverideFunction
  ): Promise<runtime.ApiResponse<InvalidateHandlerResponse>> {
    if (
      requestParameters.handler === null ||
      requestParameters.handler === undefined
    ) {
      throw new runtime.RequiredError(
        "handler",
        "Required parameter requestParameters.handler was null or undefined when calling invalidateUploadUrl."
      );
    }
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      InvalidateHandlerResponseFromJSON(jsonValue)
    );
  }
   ...
   * Invalidate Doc handler used to attach Doc to a Twin and remove uploaded Doc from temporary storage
   */
  async invalidateUploadUrl(
    requestParameters: DocsApiInvalidateUploadUrlRequest,
    initOverrides?: RequestInit | runtime.InitOverideFunction
  ): Promise<InvalidateHandlerResponse> {
    const response = await this.invalidateUploadUrlRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
  ...
  async updateTwinDocRaw(
    requestParameters: DocsApiUpdateTwinDocRequest,
    initOverrides?: RequestInit | runtime.InitOverideFunction
  ): Promise<runtime.ApiResponse<GetDoc>> {
    if (
      requestParameters.twin === null ||
