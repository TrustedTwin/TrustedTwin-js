...
export interface TwinsApiGetStickerRequest {
  twin: string;
  color: string;
}

export interface TwinsApiGetStickersRequest {
  twin: string;
}
...
export interface TwinsApiPutStickerRequest {
  twin: string;
  createStickersBody?: CreateStickersBody;
}

export interface TwinsApiRemoveStickerRequest {
  twin: string;
  color: string;
}
...
export interface TwinsApiUpdateTwinLedgerEntryValueRequest {
  twin: string;
  ledger: GetTwinLedgerEntryLedgerParameter;
...
export class TwinsApi extends runtime.BaseAPI {
   ...
   */
  async getStickerRaw(
    requestParameters: TwinsApiGetStickerRequest,
    initOverrides?: RequestInit | runtime.InitOverideFunction
  ): Promise<runtime.ApiResponse<Sticker>> {
    if (
      requestParameters.twin === null ||
      requestParameters.twin === undefined
    ) {
      throw new runtime.RequiredError(
        "twin",
        "Required parameter requestParameters.twin was null or undefined when calling getSticker."
      );
    }

    if (
      requestParameters.color === null ||
      requestParameters.color === undefined
    ) {
      throw new runtime.RequiredError(
        "color",
        "Required parameter requestParameters.color was null or undefined when calling getSticker."
      );
    }
    ...
    const response = await this.request(
      {
        path: `/twins/{twin}/stickers/{color}`
          .replace(
            `{${"twin"}}`,
            encodeURIComponent(String(requestParameters.twin))
          )
          .replace(
            `{${"color"}}`,
            encodeURIComponent(String(requestParameters.color))
          ),
        method: "GET",
        headers: headerParameters,
        query: queryParameters,
   ...
   */
  async getStickersRaw(
    requestParameters: TwinsApiGetStickersRequest,
    initOverrides?: RequestInit | runtime.InitOverideFunction
  ): Promise<runtime.ApiResponse<StickersResponse>> {
    if (
      requestParameters.twin === null ||
      requestParameters.twin === undefined
    ) {
      throw new runtime.RequiredError(
        "twin",
        "Required parameter requestParameters.twin was null or undefined when calling getStickers."
      );
    }
    ...
    const response = await this.request(
      {
        path: `/twins/{twin}/stickers`.replace(
          `{${"twin"}}`,
          encodeURIComponent(String(requestParameters.twin))
        ),
        method: "GET",
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      StickersResponseFromJSON(jsonValue)
    );
  }
  ...
  async getStickers(
    ...
    const response = await this.getStickersRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
   ...
   */
  async putStickerRaw(
    requestParameters: TwinsApiPutStickerRequest,
    initOverrides?: RequestInit | runtime.InitOverideFunction
  ): Promise<runtime.ApiResponse<CreateStickersResponse>> {
    if (
      requestParameters.twin === null ||
      requestParameters.twin === undefined
    ) {
      throw new runtime.RequiredError(
        "twin",
        "Required parameter requestParameters.twin was null or undefined when calling putSticker."
      );
    }
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      CreateStickersResponseFromJSON(jsonValue)
    );
  }
  ...
  async putSticker(
    requestParameters: TwinsApiPutStickerRequest,
    initOverrides?: RequestInit | runtime.InitOverideFunction
  ): Promise<CreateStickersResponse> {
   ...
   */
  async removeStickerRaw(
    requestParameters: TwinsApiRemoveStickerRequest,
    initOverrides?: RequestInit | runtime.InitOverideFunction
  ): Promise<runtime.ApiResponse<DeletedSticker>> {
    if (
      requestParameters.twin === null ||
      requestParameters.twin === undefined
    ) {
      throw new runtime.RequiredError(
        "twin",
        "Required parameter requestParameters.twin was null or undefined when calling removeSticker."
      );
    }
    ...
    if (
      ...
      throw new runtime.RequiredError(
        "color",
        "Required parameter requestParameters.color was null or undefined when calling removeSticker."
      );
    }
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      DeletedStickerFromJSON(jsonValue)
    );
  }
  ...
  async removeSticker(
    requestParameters: TwinsApiRemoveStickerRequest,
    initOverrides?: RequestInit | runtime.InitOverideFunction
  ): Promise<DeletedSticker> {
    const response = await this.removeStickerRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
   ...
   */
  async updateTwinLedgerEntryValueRaw(
    requestParameters: TwinsApiUpdateTwinLedgerEntryValueRequest,
    initOverrides?: RequestInit | runtime.InitOverideFunction
  ): Promise<runtime.ApiResponse<PatchedUserLedger>> {
    if (
      requestParameters.twin === null ||
      ...
      throw new runtime.RequiredError(
        "twin",
        "Required parameter requestParameters.twin was null or undefined when calling updateTwinLedgerEntryValue."
      );
    }
    ...
    if (
      ...
      throw new runtime.RequiredError(
        "ledger",
        "Required parameter requestParameters.ledger was null or undefined when calling updateTwinLedgerEntryValue."
      );
    }

    if (
      requestParameters.patchUserLedgerEntryValue === null ||
      requestParameters.patchUserLedgerEntryValue === undefined
    ) {
      throw new runtime.RequiredError(
        "patchUserLedgerEntryValue",
        "Required parameter requestParameters.patchUserLedgerEntryValue was null or undefined when calling updateTwinLedgerEntryValue."
      );
    }
    ...
    const response = await this.request(
      {
        path: `/twins/{twin}/ledgers/{ledger}/value`
          .replace(
            `{${"twin"}}`,
            encodeURIComponent(String(requestParameters.twin))
          )
        ...
        headers: headerParameters,
        query: queryParameters,
        body: PatchUserLedgerEntryValueToJSON(
          requestParameters.patchUserLedgerEntryValue
        ),
      },
      initOverrides
    );
   ...
   * PATCH one or more Entries values in given Ledger
   */
  async updateTwinLedgerEntryValue(
    requestParameters: TwinsApiUpdateTwinLedgerEntryValueRequest,
    initOverrides?: RequestInit | runtime.InitOverideFunction
  ): Promise<PatchedUserLedger> {
    const response = await this.updateTwinLedgerEntryValueRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
