...
export class UsageApi extends runtime.BaseAPI {
  ...
  async getUserUsageRaw(
    requestParameters: UsageApiGetUserUsageRequest,
    initOverrides?: RequestInit | runtime.InitOverideFunction
  ): Promise<runtime.ApiResponse<Usage>> {
    if (
      ...
      throw new runtime.RequiredError(
        "user",
        "Required parameter requestParameters.user was null or undefined when calling getUserUsage."
      );
    }
